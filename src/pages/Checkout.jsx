                ...
                <div className='md:w-2/3'>
                    <div className='border p-2 mb-6'>
                        ...
                        <div className={`space-y-4 ${billingToggle ? "" : "hidden"}`}>
                            <div>
                                <div>
                                    <label className='block textgray-700'>Name</label>
                    ...
                    {/* shipping */}
                        ...
                        <div className='border p-2 mb-6'>
                            ...
                            <div className={`space-y-4 ${shippingToggle ? "" : "hidden"}`}>
                                <div>
                                    <div>
                                        <label className='block textgray-700'>Address</label>
                                        <input 
                                            type='text' 
                                            name='name' 
                        ...
                        <div className='flex items-center justify-between' onClick={() => setPaymentToggle(!paymentToggle)}>
                            <h3 className='text-lg font-semibold mb-2'>Pament Method</h3>
                        ...
                        <div className={`space-y-4 ${paymentToggle ? "" : "hidden"}`}>
                            ...
                            {paymentMethod === "dc" && (
                                <div className='bg-gray-100 p-4 rounded-lg mb-4'>
                                    ...
                                    <div className='mb-4'>
                                        <label htmlFor='block text-gray-700 font-semibold mb-2'>Card Holder Name</label>
                                        <input type='text'
